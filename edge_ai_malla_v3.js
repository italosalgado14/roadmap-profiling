...
export const TRACKS = {
  ...
  applied:  { color: "#db2777", label: "Applied AI / LLM",            short: "Applied"   },
  data:     { color: "#0d9488", label: "Data & AI platform",          short: "Data"      },
};
...
export const COURSES = [
  ...
  { id: "PIPE", phase: "P1", row: 3, label: "Data pipelines & SQL",
    priority: "critical", kind: "branch", tracks: ["data","platform"],
    prereqs: ["PY","LINUX"],
  ...
  { id: "LLM", phase: "P3", row: 2, label: "LLM fundamentals",
    priority: "critical", kind: "branch", tracks: ["edge","robotics","compiler","platform","applied"],
    prereqs: ["DL"],
  ...
  { id: "STREAM", phase: "P3", row: 3, label: "Real-time streaming",
    priority: "critical", kind: "branch", tracks: ["data","platform","edge"],
    prereqs: ["PIPE","DOC"],
  ...
  { id: "RAG", phase: "P4", row: 2, label: "RAG & vector DBs",
    priority: "critical", kind: "branch", tracks: ["edge","applied"],
    prereqs: ["LLM"],
  ...
  { id: "FINE", phase: "P4", row: 3, label: "LLM fine-tuning",
    priority: "desirable", kind: "branch", tracks: ["edge","robotics","applied"],
    prereqs: ["LLM"],
  ...
  { id: "KERNEL", phase: "P4", row: 6, label: "GPU kernels & profiling",
    ...
    res:  "Triton tutorials (free) | CUTLASS GitHub (free) | NVIDIA Nsight Compute docs (free) | MIT 6.5940 TinyML and Efficient Deep Learning (free), why: the best structured course on pruning, quantization and distillation" },
  ...
  { id: "EVAL", phase: "P4", row: 9, label: "AI evaluation",
    priority: "critical", kind: "branch", tracks: ["applied","edge","platform","data"],
    prereqs: ["LLM","ML"],
  ...
  { id: "FEAT", phase: "P4", row: 10, label: "Feature store & training data",
    priority: "desirable", kind: "branch", tracks: ["data","platform"],
    prereqs: ["LAKE","MLOPS"],
    ...
    res:  "Feast docs (free) | Book: Designing Machine Learning Systems, Chip Huyen, why: the feature chapter frames the skew problem best | Tecton engineering blog (free)" },

  { id: "TSDB", phase: "P4", row: 11, label: "IoT & time-series data",
    priority: "desirable", kind: "branch", tracks: ["data","edge"],
    prereqs: ["STREAM"],
  ...
  { id: "AGENT", phase: "P5", row: 1, label: "Multi-agent systems",
    priority: "desirable", kind: "branch", tracks: ["edge","platform","applied"],
    prereqs: ["RAG","MLOPS"],
  ...
  { id: "SERVE", phase: "P5", row: 4, label: "LLM serving & inference",
    priority: "critical", kind: "branch", tracks: ["applied","platform","edge"],
    prereqs: ["LLM","DOC"],
    desc: "vLLM and TGI, continuous batching, KV-cache management, quantized serving, streaming responses, and latency and cost budgets under real traffic.",
    res:  "vLLM docs (free), why: the reference implementation of paged attention | Hugging Face TGI docs (free) | Book: AI Engineering, Chip Huyen" },

  { id: "DATAENG", phase: "P5", row: 5, label: "Data engine & synthetic data",
    priority: "desirable", kind: "branch", tracks: ["edge","robotics","data"],
    prereqs: ["CV"],
  ...
  { id: "VLM", phase: "P6", row: 0, label: "Vision-language models",
    priority: "critical", kind: "branch", tracks: ["edge","robotics","applied"],
    prereqs: ["VIT","JET"],
  ...
  { id: "K8S", phase: "P7", row: 1, label: "Kubernetes for ML",
    priority: "desirable", kind: "branch", tracks: ["platform","edge","robotics","data"],
    prereqs: ["DOC","MLOPS"],
  ...
  { id: "CAPAPP", phase: "P7", row: 4, label: "Capstone: Applied AI",
    priority: "critical", kind: "branch", tracks: ["applied"],
    prereqs: ["SERVE","EVAL","AGENT"],
    desc: "One LLM system in production shape: retrieval or tools, a real evaluation suite with a regression gate, cost and latency budgets, and a written account of what the evaluations caught. The proof for an Applied AI profile.",
    res:  "No course. Ship it with the evaluation harness public, why: the harness is the part that is hard to fake" },

  { id: "CAPDATA", phase: "P7", row: 5, label: "Capstone: Data platform",
    priority: "critical", kind: "branch", tracks: ["data","platform"],
    prereqs: ["FEAT","STREAM"],
  ...
  { id: "NEURO", phase: "P8", row: 1, label: "Neuromorphic computing",
    ...
    prereqs: ["CPP","JET"],
    desc: "Spiking neural networks, Intel Loihi 2, ultra-low-power edge AI. Research-grade today, with no established hiring market.",
