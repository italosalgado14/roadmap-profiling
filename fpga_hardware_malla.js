...
export const COURSES = [
  ...
  { id: "NUMFMT", phase: "P1", row: 2, label: "Number formats & fixed point",
    ...
    res:  "Book: Digital Signal Processing, Lyons, fixed-point chapters | ARM and Xilinx fixed-point application notes (free)" },
  ...
  { id: "CLOCKS", phase: "P3", row: 2, label: "Clock domains & CDC",
    ...
    res:  "Cummins papers on CDC and asynchronous FIFO design (free), why: the canonical treatment, still unmatched | Vendor CDC analysis tooling docs (free)" },
  ...
  { id: "QUANTZ", phase: "P6", row: 5, label: "Quantization for hardware",
    ...
    res:  "Brevitas and FINN documentation (free) | MIT 6.5940 TinyML and Efficient Deep Learning (free), why: the pruning and quantization lectures are the relevant half | Papers on QAT (free)" },
  ...
  { id: "ASIC", phase: "P8", row: 2, label: "ASIC flow & open silicon",
    ...
    res:  "OpenLane and Sky130 open PDK (free), why: a genuine tapeout flow you can run at home | Efabless shuttle programs | Zero to ASIC course (paid)" },
