...
export const COURSES = [
  ...
  { id: "LINUX", phase: "P0", row: 0, label: "Linux & CLI",
    ...
    res:  "Linux Journey (free) | MIT Missing Semester (free) | OverTheWire Bandit wargame (free)" },
  { id: "PY", phase: "P0", row: 1, label: "Python",
    ...
    res:  "Automate the Boring Stuff (free) | Black Hat Python, Seitz (paid) | requests / httpx docs (free)" },
  { id: "NET", phase: "P0", row: 2, label: "Networking & protocols",
    ...
    res:  "Computer Networking: A Top-Down Approach (book) | Wireshark docs & captures (free) | Cloudflare Learning Center (free)" },
  { id: "WEB", phase: "P0", row: 3, label: "Web platform & HTTP",
    ...
    res:  "MDN Web Docs (free) | PortSwigger Web Security Academy (free) | web.dev security (free)" },
  { id: "OS", phase: "P0", row: 4, label: "OS internals & memory model",
    ...
    res:  "OSTEP, Operating Systems: Three Easy Pieces (free) | Nand2Tetris (free) | pwn.college (free)" },
  { id: "THREAT", phase: "P0", row: 5, label: "Security fundamentals & threat modeling",
    ...
    res:  "Threat Modeling, Shostack (paid) | OWASP Threat Modeling Cheat Sheet (free) | CompTIA Security+ objectives (free)" },
  { id: "GO", phase: "P0", row: 6, label: "Go / systems programming",
    ...
    res:  "A Tour of Go (free) | Go by Example (free) | The Go Programming Language, Donovan & Kernighan (paid)" },
  ...
  { id: "OWASP", phase: "P1", row: 0, label: "OWASP Top 10 & web vulns",
    ...
    res:  "OWASP Top 10 (free) | PortSwigger Web Security Academy labs (free) | PentesterLab (freemium)" },
  { id: "SECCODE", phase: "P1", row: 1, label: "Secure coding & code review",
    ...
    res:  "OWASP Cheat Sheet Series (free) | OWASP ASVS (free) | Secure by Design, Johnsson et al. (paid)" },
  { id: "AUTHZ", phase: "P1", row: 2, label: "AuthN/AuthZ & session security",
    ...
    res:  "OWASP Authentication & Session Cheat Sheets (free) | PortSwigger access control labs (free) | NIST SP 800-63B (free)" },
  { id: "SAST", phase: "P1", row: 3, label: "SAST / DAST & fuzzing",
    ...
    res:  "Semgrep & CodeQL docs (free) | OWASP ZAP (free) | Google/OSS-Fuzz & libFuzzer docs (free)" },
  { id: "APPSEC_TEST", phase: "P1", row: 4, label: "Pentesting & exploitation basics",
    ...
    res:  "TryHackMe & Hack The Box (freemium) | HackTricks (free) | PEN-200/OSCP, OffSec (paid)" },
  { id: "API", phase: "P1", row: 5, label: "API & mobile security",
    ...
    res:  "OWASP API Security Top 10 (free) | OWASP MASVS/MASTG (free) | PortSwigger GraphQL & API labs (free)" },
  ...
  { id: "CICD", phase: "P2", row: 0, label: "CI/CD security",
    ...
    res:  "OWASP CI/CD Security Top 10 (free) | GitHub Actions security hardening docs (free) | SLSA framework (free)" },
  { id: "IAC", phase: "P2", row: 1, label: "IaC & policy as code",
    ...
    res:  "Terraform & OpenTofu docs (free) | Open Policy Agent / Rego (free) | Checkov & Trivy (free), why: tfsec is retired, its checks live in Trivy now" },
  { id: "CONTAINER", phase: "P2", row: 2, label: "Container & Kubernetes security",
    ...
    res:  "Kubernetes security docs & CIS Benchmark (free) | Falco & Trivy (free) | Container Security, Rice (paid)" },
  { id: "SUPPLY", phase: "P2", row: 3, label: "Software supply chain & SBOM",
    ...
    res:  "SLSA & in-toto (free) | Sigstore / cosign (free) | CycloneDX & SPDX SBOM specs (free)" },
  { id: "SECRETS", phase: "P2", row: 4, label: "Secrets management",
    ...
    res:  "HashiCorp Vault docs (free) | gitleaks & trufflehog (free) | Cloud secrets-manager docs (free)" },
  { id: "DEPMGMT", phase: "P2", row: 5, label: "Dependency & vulnerability management",
    ...
    res:  "OWASP Dependency-Check & Dependabot (free) | OSV & FIRST EPSS (free) | CISA Known Exploited Vulnerabilities catalog (free)" },
  ...
  { id: "CLOUDSEC", phase: "P3", row: 0, label: "Cloud security fundamentals",
    ...
    res:  "AWS/Azure/GCP well-architected security docs (free) | CIS Benchmarks (free) | flAWS & CloudGoat labs (free)" },
  { id: "IAM", phase: "P3", row: 1, label: "Cloud IAM & least privilege",
    ...
    res:  "AWS IAM & Azure Entra docs (free) | Cloud IAM privilege-escalation research, Rhino Security (free) | Cloudsplaining & pathfinding.cloud (free), why: PMapper has gone unmaintained" },
  { id: "NETSEC", phase: "P3", row: 2, label: "Network security & zero trust",
    ...
    res:  "NIST SP 800-207 Zero Trust Architecture (free) | BeyondCorp papers, Google (free) | Cloud networking security docs (free)" },
  { id: "CSPM", phase: "P3", row: 3, label: "CSPM & cloud posture",
    ...
    res:  "Prowler & ScoutSuite (free) | Steampipe / CloudQuery (free) | CIS cloud benchmarks (free)" },
  { id: "LOGGING", phase: "P3", row: 4, label: "Logging, monitoring & SIEM",
    ...
    res:  "Elastic Security & OpenSearch docs (free) | AWS CloudTrail / GCP Audit Logs docs (free) | Splunk free training courses (free)" },
  ...
  { id: "CRYPTO", phase: "P4", row: 0, label: "Applied cryptography",
    ...
    res:  "Serious Cryptography, Aumasson (paid) | Cryptopals challenges (free) | Dan Boneh, Crypto I, Coursera (free audit)" },
  { id: "PKI", phase: "P4", row: 1, label: "PKI, TLS & certificate management",
    ...
    res:  "Bulletproof TLS and PKI, Ristić (paid) | Let's Encrypt / ACME docs (free) | SSL Labs test & guides (free)" },
  { id: "IDENTITY", phase: "P4", row: 2, label: "Identity federation (OAuth/OIDC/SAML)",
    ...
    res:  "OAuth 2 in Action, Richer & Sanso (paid) | oauth.net & OpenID Connect specs (free) | Keycloak docs (free)" },
  { id: "PQC", phase: "P4", row: 3, label: "Post-quantum cryptography",
    ...
    res:  "NIST FIPS 203/204/205 (free) | Open Quantum Safe / liboqs (free) | Cloudflare PQC blog series (free)" },
  { id: "KEYMGMT", phase: "P4", row: 4, label: "Key management & HSM/KMS",
    ...
    res:  "Cloud KMS docs, AWS/Azure/GCP (free) | NIST SP 800-57 key management (free) | PKCS#11 / HSM primers (free)" },
  ...
  { id: "AIML_BASICS", phase: "P5", row: 0, label: "ML / LLM systems literacy",
    ...
    res:  "DeepLearning.AI short courses (free) | Hands-On Large Language Models, Alammar & Grootendorst (paid) | Anthropic & OpenAI docs (free)" },
  { id: "LLM_TOP10", phase: "P5", row: 1, label: "OWASP LLM Top 10 & prompt injection",
    ...
    res:  "OWASP GenAI Security Project: LLM Top 10 2026 (free) | Lakera Gandalf: Agent Breaker & prompt-injection primers (free) | Simon Willison's writing (free)" },
  { id: "AGENT_SEC", phase: "P5", row: 2, label: "Agent & tool-use security",
    ...
    res:  "OWASP Agentic Security Initiative: Securing Agentic Applications guide (free) | Anthropic MCP & tool-use docs (free) | Google/Microsoft agent security guidance (free)" },
  { id: "AICODE_AUDIT", phase: "P5", row: 3, label: "AI-generated code auditing",
    ...
    res:  "GitHub Copilot & Claude Code security docs (free) | Semgrep AI-code rules (free) | 'slopsquatting' / hallucinated-dependency research (free)" },
  { id: "MODEL_SUPPLY", phase: "P5", row: 4, label: "Model & data supply-chain security",
    ...
    res:  "safetensors & model-scanning tools (free) | Hugging Face security docs (free) | NIST/MITRE data-poisoning literature (free)" },
  { id: "ADV_ML", phase: "P5", row: 5, label: "Adversarial ML & model robustness",
    ...
    res:  "MITRE ATLAS (free) | Adversarial Robustness Toolbox, IBM ART (free) | NIST AI 100-2 E2025 adversarial ML taxonomy (free)" },
  { id: "PRIVACY", phase: "P5", row: 6, label: "Data privacy & PETs",
    ...
    res:  "The Algorithmic Foundations of DP, Dwork & Roth (free) | OpenMined & Opacus tutorials (free) | NIST privacy framework (free)" },
  { id: "REDTEAM_AI", phase: "P5", row: 7, label: "AI red-teaming & security evals",
    ...
    res:  "Microsoft PyRIT (free) | NVIDIA garak LLM scanner (free) | Anthropic/OpenAI red-teaming writeups (free)" },
  ...
  { id: "DETECT", phase: "P6", row: 0, label: "Detection engineering & threat hunting",
    ...
    res:  "Sigma rules project (free) | MITRE ATT&CK (free) | The DFIR Report & detection.fyi (free)" },
  { id: "IR", phase: "P6", row: 1, label: "Incident response & forensics",
    ...
    res:  "NIST SP 800-61r3 (free) | Blue Team Handbook, Murdoch (paid) | TheHive & Velociraptor (free)" },
  { id: "THREATINTEL", phase: "P6", row: 2, label: "Threat intel & MITRE ATT&CK",
    ...
    res:  "MITRE ATT&CK & ATT&CK Navigator (free) | MISP threat-intel platform (free) | The Pyramid of Pain, Bianco (free)" },
  { id: "VULN", phase: "P6", row: 3, label: "Vulnerability management program",
    ...
    res:  "CISA vuln-management guidance (free) | FIRST CVSS & EPSS (free) | Nuclei & OpenVAS scanners (free)" },
  ...
  { id: "GRC_FUND", phase: "P7", row: 0, label: "Security governance & risk",
    ...
    res:  "NIST Cybersecurity Framework 2.0 (free) | ISO/IEC 27001 overview (free) | CIS Controls v8.1 (free)" },
  { id: "AI_GOV", phase: "P7", row: 1, label: "AI governance & assurance",
    ...
    res:  "NIST AI Risk Management Framework + GenAI profile (free) | EU AI Act text & timelines (free) | ISO/IEC 42001 overview (free)" },
  { id: "COMPLIANCE", phase: "P7", row: 2, label: "Compliance & audit",
    ...
    res:  "AICPA SOC 2 & PCI-DSS quick refs (free) | GDPR + Chile Law 21.719 primers (free) | NIST OSCAL compliance-as-code (free), why: it superseded OpenControl as the standard format" },
  { id: "SECURE_SDLC", phase: "P7", row: 3, label: "Secure SDLC & program design",
    ...
    res:  "OWASP SAMM & BSIMM (free) | Microsoft SDL (free) | Building Secure & Reliable Systems, Google/O'Reilly (free)" },
  ...
  { id: "FORMAL", phase: "P8", row: 0, label: "Formal methods & verification",
    ...
    res:  "Learn TLA+, Wayne (free) | Software Foundations, Pierce (free) | seL4 verified-kernel papers (free)" },
  { id: "CONFIDENTIAL", phase: "P8", row: 1, label: "Confidential computing & TEEs",
    ...
    res:  "Confidential Computing Consortium docs (free) | Intel SGX / AMD SEV / AWS Nitro docs (free) | Enarx & attestation primers (free)" },
  { id: "AISEC_RESEARCH", phase: "P8", row: 2, label: "AI security research frontier",
    ...
    res:  "arXiv cs.CR + cs.AI (free) | Anthropic & Google DeepMind safety research (free) | AI Village / DEF CON red-team writeups (free)" },
  { id: "LEAD", phase: "P8", row: 3, label: "Technical leadership",
    ...
    res:  "The Manager's Path, Fournier (paid) | Google Technical Writing (free) | CISA & sector CISO playbooks (free)" },
  { id: "ARCH", phase: "P8", row: 4, label: "Security architecture",
    ...
    res:  "Building Secure & Reliable Systems, Google (free) | SABSA & reference architectures (free) | AWS/Azure security reference architectures (free)" },
];
