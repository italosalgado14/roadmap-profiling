...
export const OPTIONS = [
  ...
  },
  {
    ...
    job: "Design the silicon behaviour itself: digital logic in HDL, timing closure, verification, board bring-up, and the firmware and real-time software that runs on it. Not writing software for hardware somebody else designed, but designing the datapath.",
    hiring: {
      cl: "Thin locally, concentrated in instrumentation, mining equipment suppliers and a small test-and-measurement base.",
      de: "Strong and stable across automotive, industrial automation, medical devices and aerospace, with a deep supplier network.",
      ca: "Moderate, concentrated in aerospace and defence, telecom, and hardware startups.",
    },
    entry: "An electronics or computer-engineering background is the natural route in, and C plus an HDL are non-negotiable. The slowest path on this map to enter, because hardware iteration loops run in days rather than seconds.",
    fit: "Good fit if you like determinism, want the layer under everything else, and can tolerate a feedback loop measured in synthesis runs.",
    depth: "graph",
    route: "#/fpga-malla",
  },
  {
