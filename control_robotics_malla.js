...
export const COURSES = [
  ...
  { id: "DIGITAL", phase: "P1", row: 2, label: "Digital control",
    ...
    res:  "Brian Douglas Discrete control series (free YT) | Franklin, Powell & Workman Digital Control of Dynamic Systems, free e-edition PDF at scsolutions.com | Astrom & Wittenmark Computer-Controlled Systems, Dover 3rd ed. (~$40) | MathWorks Control Systems in Practice: 4 Ways to Implement a Transfer Function in Code (free YT)" },
  ...
  { id: "NLEST", phase: "P3", row: 1, label: "Nonlinear estimation (EKF/UKF)",
    ...
    res:  "Roger Labbe, Kalman and Bayesian Filters in Python (free) | Cyrill Stachniss EKF/UKF/PF lectures (free YT) | Dan Simon, Optimal State Estimation (~$80 used) | Thrun, Burgard & Fox, Probabilistic Robotics (~$110)" },
  ...
  { id: "SLAM", phase: "P3", row: 3, label: "SLAM",
    ...
    res:  "Cyrill Stachniss SLAM Course (free YT) | Thrun, Burgard & Fox Probabilistic Robotics (~$110) | Cadena et al. Past/Present/Future of SLAM survey, arXiv (free) | GTSAM + Dellaert Factor Graphs hands-on tutorial (free)" },
  ...
  { id: "MOTION", phase: "P7", row: 0, label: "Motion & manipulator control",
    ...
    res:  "Modern Robotics Ch.11 Robot Control, Lynch & Park (free) | MR Coursera Course 4: Robot Motion Planning & Control (audit) | Spong, Hutchinson & Vidyasagar, Robot Modeling and Control 2e (~$140) | Khatib 1987 Operational Space Formulation (free PDF) | Siciliano et al., Robotics: Modelling, Planning and Control, softcover (~$90)" },
  ...
  { id: "GNC", phase: "P7", row: 5, label: "Guidance, navigation & control",
    ...
    res:  "Beard & McLain UAVbook draft + mavsim repo, uavbook.byu.edu (free) | MATLAB Drone Simulation & Control + Autonomous Navigation series (free YT) | PX4 controller diagrams / ArduPilot dev docs (free) | Markley & Crassidis Spacecraft Attitude, softcover (~$90)" },
